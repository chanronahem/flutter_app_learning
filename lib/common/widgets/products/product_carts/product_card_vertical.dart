...
import 'package:flutter_app_learning/common/styles/shadows.dart';
import 'package:flutter_app_learning/common/widgets/custom_shapes/containers/rounded_container.dart';
import 'package:flutter_app_learning/common/widgets/images/t_rounded_image.dart';
import 'package:flutter_app_learning/common/widgets/texts/product_title_text.dart';
          ...
          children: [
            ...
            TRoundedContainer(
              ...
              child: Stack(
                children: [
                  /// Thumbnail Images
                  TRoundedImage(imageUrl: TImages.productImage1, applyImageRadius: true, backgroundColor: dark ? TColors.dark : TColors.light),
            ...
            // Todo: Add spacer to keep the height of each box same in case 1 or 2 lines of headings
            const Spacer(),
