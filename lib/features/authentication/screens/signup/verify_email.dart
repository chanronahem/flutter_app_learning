...
import 'package:flutter_app_learning/common/widgets/success_screen/success_screen.dart';
import 'package:flutter_app_learning/features/authentication/screens/login/login.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text('mail@email.com', style: Theme.of(context).textTheme.labelLarge, textAlign: TextAlign.center),
              const SizedBox(height: TSizes.spaceBtwItems),
